...
def countNode(update, context):
    ...
    if is_gdrive_link(link):
        msg = sendMessage(f"Perhitungan: <code>{link}</code>", context.bot, update)
        ...
        sendMessage('Kirim tautan Gdrive dengan perintah atau dengan membalas tautan dengan perintah', context.bot, update)
